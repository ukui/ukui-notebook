...
iconViewModeDelegate::iconViewModeDelegate(QFont currentFont, QObject *parent)
    : QStyledItemDelegate(parent),
      m_titleFont(currentFont.family(), currentFont.pointSizeF()/15 * 14),              //标题字体
      m_titleSelectedFont(currentFont.family(), currentFont.pointSizeF()/15 * 30),          //
      m_dateFont(currentFont.family(), currentFont.pointSizeF()/15 * 10),                   //日期字体
...
void iconViewModeDelegate::paintLabels(QPainter* painter, const QStyleOptionViewItem& option, const QModelIndex& index) const
{
    ...
    m_titleSelectedFont.setPointSizeF(g_currentFont.pointSizeF()/15 * 30);
    m_dateFont.setFamily(g_currentFont.family());
    m_dateFont.setPointSizeF(g_currentFont.pointSizeF()/15 * 10);
